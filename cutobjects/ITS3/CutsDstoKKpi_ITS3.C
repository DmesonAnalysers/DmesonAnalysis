...
// Methods:
// 1) MakeFileForCutsDs_FiltTree_ITS2_MC --> filtering cuts for tree used for ITS2 MC simulation studies with ML
//
// 2) MakeFileForCutsDs_FiltTree_ITS2_Data --> filtering cuts for tree used for ITS2 Data studies with ML
//
// 3) MakeFileForCutsDs_FiltTree_ITS3 --> filtering cuts for tree used for ITS3 D studies with ML
//___________________________________________________________________________________________________//


AliRDHFCutsDstoKKpi* MakeFileForCutsDs_FiltTree_ITS2_MC(double ptmin=1., double ptmax=50.) {
...
AliRDHFCutsDstoKKpi* MakeFileForCutsDs_FiltTree_ITS2_Data(double ptmin=1., double ptmax=50.) {
    ...
    TFile* fout=new TFile(Form("DstoKKpiCutsITS2_filttree_kINT7_kCentral_consPID_pt%0.f_%0.f.root",ptmin,ptmax),"recreate");
    fout->cd();
    analysiscuts->Write();
    fout->Close();

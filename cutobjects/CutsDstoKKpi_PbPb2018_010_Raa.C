...
void MakeFileForCuts_Loose2018(Bool_t fUseStrongPID = kTRUE, Double_t maxPtstrongPID = 8.0) {
    ...
    anacutsval[17][0]=0.;    //normdecay
    anacutsval[18][0]=6.0;   //normdecayXY
    ...
    anacutsval[17][1]=0.;    //normdecay
    anacutsval[18][1]=6.0;   //normdecayXY
    ...
    Float_t topomCuts[nptbins] = {3.,3.,4.,4.,4.,4.,5.,5.,5.}; //topomatic
    Float_t d0Cuts[nptbins] = {300.,300.,300.,300.,300.,300.,300.,300.,300.}; //topomatic

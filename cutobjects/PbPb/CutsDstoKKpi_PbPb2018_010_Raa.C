...
AliRDHFCutsDstoKKpi* MakeFileForCutsDs010_Filt2018_pass3(bool fUseStrongPID = false, double maxPtstrongPID = 8.0, bool fIsMC=false, double ptmin=2., double ptmax=50.) {

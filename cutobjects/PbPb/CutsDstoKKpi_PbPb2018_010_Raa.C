...
// 6) MakeFileForCutsDs010_Central2018_Pass3 --> central cuts of 2018 analysis + Pass3 updates
// 7) MakeFileForCutsDs010_Filt2018_Pass3 --> filtering cuts of 2018 analysis, application on grid + Pass3 updates
//____________________________________________________________________________________________________//
...
AliRDHFCutsDstoKKpi* MakeFileForCutsDs010_Central2018(bool fUseStrongPID = true, double maxPtstrongPID = 8.0, bool fIsMC=false, int addTrackCut = 0, double ptmin=2., double ptmax=50.) {
    ...
    TFile* fout=new TFile(Form("DstoKKpiCuts_010_central%s_Raa_%s%s_pt%0.f_%0.f_pass1.root",pidname.Data(), triggername.Data(),trackCutName.Data(),ptmin,ptmax),"recreate");
    fout->cd();
    analysiscuts->Write();
    fout->Close();
...
AliRDHFCutsDstoKKpi* MakeFileForCutsDs010_Central2018_Pass3(bool fUseStrongPID = true, double maxPtstrongPID = 8.0, bool fIsMC=false, int addTrackCut = 0, double ptmin=2., double ptmax=50.) {
    ...
    TFile* fout=new TFile(Form("DstoKKpiCuts_010_central%s_Raa_%s%s_pt%0.f_%0.f_2018pass3.root",pidname.Data(), triggername.Data(),trackCutName.Data(),ptmin,ptmax),"recreate");
    fout->cd();
    analysiscuts->Write();
    fout->Close();
...
AliRDHFCutsDstoKKpi* MakeFileForCutsDs010_Filt2018_Pass3(bool fIsMC=false, double ptmin=2., double ptmax=50., int preselType=kTightQM) {
    ...
    const int nptbins=3;
    float ptbins[nptbins+1]={0.,4., 6., 50.};
    ...
    anacutsval[9][2]=0.9;
    anacutsval[10][2]=0.;
    anacutsval[11][2]=1000.;
    anacutsval[12][2]=0.015;
    anacutsval[13][2]=0.0001;
    anacutsval[14][2]=0.;
    anacutsval[15][2]=1.;
    anacutsval[16][2]=0.;
    anacutsval[17][2]=0.;

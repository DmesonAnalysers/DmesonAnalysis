...
// 2) MakeFileForCutsDsVn3050_Central_Pass3 --> central cuts of v2 2018 analysis + Pass3 updates
//____________________________________________________________________________________________________//
...
AliRDHFCutsDstoKKpi* MakeFileForCutsDsVn3050_Central_Pass3(bool fUseStrongPID = true, double maxPtstrongPID = 8.0) {

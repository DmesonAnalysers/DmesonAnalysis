...
hEffPrompt = TH1F('hEffPrompt',';#it{p}_{T} (GeV/#it{c});(Acc #times #epsilon);',nPtBins,array.array('f',PtLims))
hEffFD = TH1F('hEffFD',';#it{p}_{T} (GeV/#it{c});(Acc #times #epsilon);',nPtBins,array.array('f',PtLims))
...
cEff.DrawFrame(PtMin[0],1.e-5,PtMax[nPtBins-1],1.,';#it{p}_{T} (GeV/#it{c});(Acc #times #epsilon);')
cEff.SetLogy()

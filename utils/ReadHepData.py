...
def ReadHepDataROOT(HepDataFileName, tablenum):
    ...
    Hist1D_y1_e2 = table.Get('Hist1D_y1_e2')
    ...
    for iPt in range(Hist1D_y1.GetNbinsX()):
        ...
        systlow = math.sqrt(Hist1D_y1_e2minus.GetBinContent(iPt+1)**2)
        #systlow = math.sqrt(Hist1D_y1_e2minus.GetBinContent(iPt+1)**2+Hist1D_y1_e3.GetBinContent(iPt+1)**2)
        systhigh = math.sqrt(Hist1D_y1_e2plus.GetBinContent(iPt+1)**2)
        ...
        graphSyst.SetPointError(iPt, histoStat.GetBinWidth(iPt+1)/4, histoStat.GetBinWidth(iPt+1)/4, systlow, systhigh)
